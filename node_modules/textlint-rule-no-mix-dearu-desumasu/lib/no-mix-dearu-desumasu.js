...
module.exports = function noMixedDearuDesumasu(context) {
    ...
    var ignoreManger = new _textlintRuleHelper.IgnoreNodeManger();
    ...
    return _ref = {}, _defineProperty(_ref, Syntax.Header, function (node) {
        ...
        return Promise.all([bodyChecker.checkout(ignoreManger), headerChecker.checkout(ignoreManger), listChecker.checkout(ignoreManger)]);
    }), _ref;
};
