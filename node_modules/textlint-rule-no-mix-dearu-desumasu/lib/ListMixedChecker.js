...
var ListMixedChecker = function (_MixedChecker) {
    ...
    function ListMixedChecker() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(ListMixedChecker).apply(this, arguments));
    }

    _createClass(ListMixedChecker, [{
        key: "outputMessage",
        value: function outputMessage(token) {
            return "箇条書き: " + _get(Object.getPrototypeOf(ListMixedChecker.prototype), "outputMessage", this).call(this, token);
        }
    }]);
